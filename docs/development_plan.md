...
- **Active phase:** **P3** (`bymax-auth-core` — engine, builder, config profiles, trait set) 🔄 In Progress
- **Blocked:** —
...
| P3 | `bymax-auth-core` — engine, builder, config profiles, trait set | 🔄 In Progress | 6/6 | L | 2026-06-19 |
